  ...
  return (
    <>
      ...
      <div class=" py-6 px-6 space-x-8 flex flex-col lg:flex-row">
        <Aside />
        <div class="bg-white p-8 rounded-lg w-[979px] ">
          {/* <!-- Title --> */}
          <h2 class="text-2xl font-semibold text-black mb-6">
            Account Settings
          </h2>
          <h2 class="text-md font-semibold text-black mb-2">Profile Picture</h2>

          {/* <!-- Profile Picture Upload Section --> */}
          <div class="flex items-center mb-6">
            <img src={jhon} alt="profile" class="w-20 h-20 rounded-full mr-4" />
            <div class="space-x-4">
